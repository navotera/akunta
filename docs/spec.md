...
Admin dan Super Admin dapat mengaktifkan beberapa periode yang tidak saling
tumpang tindih pada entitas yang menjadi scope assignment-nya. Aktivasi hanya
mengubah status periode target menjadi terbuka; pilihan periode aktif tetap
tersimpan per sesi/browser, sehingga mengaktifkan periode lain tidak menutup
periode yang masih terbuka. Role lain tidak memperoleh izin aktivasi hanya
karena dapat membaca daftar periode.
