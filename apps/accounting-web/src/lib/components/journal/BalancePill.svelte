...
{#if balanced}
  <span
    class="inline-flex items-center gap-2 rounded-full bg-paid-light px-3 py-1 text-xs font-bold text-paid"
  ...
  >
    <svg
      ...
      stroke="currentColor"
      stroke-width="2.5"
      ><path d="M3 8.5l3 3 7-7" stroke-linecap="round" stroke-linejoin="round" /></svg
    >
    Jurnal Balance
  </span>
{:else}
  <span
    class="inline-flex items-center gap-2 rounded-full bg-page-bg px-3 py-1 text-xs font-bold text-text-muted"
    data-testid="balance-pill"
  >
