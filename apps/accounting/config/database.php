    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'options' => extension_loaded('pdo_mysql') && env('MYSQL_ATTR_SSL_CA') && defined('Pdo\\Mysql::ATTR_SSL_CA')
                ...
                : (extension_loaded('pdo_mysql') && env('MYSQL_ATTR_SSL_CA')
        ...
        'ecosystem_control' => [
            ...
            'database' => env('CONTROL_DB_DATABASE', 'ecosystem_control'),
            'username' => env('CONTROL_DB_USERNAME', env('DB_USERNAME', 'postgres')),
