<div class="ak-brand">
    <span class="ak-brand-mark" aria-hidden="true">
        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none">
            <rect width="32" height="32" rx="7" fill="url(#ak-brand-grad)"/>
            ...
            <defs>
                <linearGradient id="ak-brand-grad" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
