...
class RecordPurchaseAction
{
    ...
    public function execute(array $input): Journal
    {
        ...
        if (! $purchase->isAvailableFor($journalMode) || ! $payment->isAvailableFor($journalMode)) {
            throw new RuntimeException("Akun pembelian tidak tersedia untuk jurnal {$journalMode}.");
        }
